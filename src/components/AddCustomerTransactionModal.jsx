...
export function AddCustomerTransactionModal({ isOpen, onClose, customer }) {
    const { addCustomerTransaction, cars } = useDriveway()
    ...
    const handleSubmit = () => {
        if (!formData.amount || !customer) return
    ...
    return (
        <Dialog isOpen={isOpen} onClose={onClose} className="max-w-md bg-[#0c0a09] border-white/10 text-white p-0 gap-0">
            <DialogHeader className="px-6 py-4 border-b border-white/10">
                ...
                <p className="text-xs text-slate-500">Record a credit or debit for {customer.name}</p>
            </DialogHeader>
            ...
            <div className="p-6 space-y-4">
                ...
                <div className="space-y-1">
                    ...
                    <textarea
                        ...
                        placeholder="e.g. Additional Payment, Late Fee, Refund..."
