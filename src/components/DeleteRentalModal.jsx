...
export function DeleteRentalModal({ isOpen, onClose, onConfirm, rental }) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // This is a simple way to verify ownership without managing separate hashes
        ...
        >
            ...
            <div className="p-6 pb-0">
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-white mb-1">Delete Rental Record?</h2>
                        <p className="text-sm text-gray-400 leading-relaxed">
                            You are about to permanently delete the rental agreement <span className="font-mono font-bold text-white">#{rental.id.slice(0, 6).toUpperCase()}</span>.
            ...
            <div className="px-6 py-6">
                <div className="bg-[#292524]/50 rounded-xl border border-white/5 p-4 space-y-3">
                    <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="font-bold text-white">{rental.car?.make} {rental.car?.model}</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="font-medium text-white">
                            {new Date(rental.startDate).toLocaleDateString(undefined, { month: 'short', day: 'numeric' })} - {new Date(rental.endDate).toLocaleDateString(undefined, { month: 'short', day: 'numeric', year: 'numeric' })}
                        </span>
                    </div>
                    <div className="h-px bg-white/5" />
                    <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="font-bold text-white">{rental.customer?.name}</span>
                    </div>
                </div>
